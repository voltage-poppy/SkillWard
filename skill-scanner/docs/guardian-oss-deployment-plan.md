...
parser.add_argument("--llm-model",
    default=os.getenv("GUARDIAN_LLM_MODEL", ""))
parser.add_argument("--llm-api-key",
    default=os.getenv("GUARDIAN_LLM_API_KEY", ""))
...
services:
  ...
  api:
    ...
    environment:
      - GUARDIAN_LLM_MODEL=${GUARDIAN_LLM_MODEL:-openai/gpt-4o-mini}
...
services:
  ...
  api:
    ...
    volumes:
      - /var/run/docker.sock:/var/run/docker.sock
    environment:
      - GUARDIAN_LLM_MODEL=${GUARDIAN_LLM_MODEL:-qwen3guard}
      - GUARDIAN_LLM_API_BASE=http://fangcunguard:5001
      - GUARDIAN_SANDBOX_IMAGE=guardian-sandbox:latest
...
GUARDIAN_LLM_MODEL=openai/gpt-4o-mini
GUARDIAN_LLM_API_KEY=sk-your-key-here
