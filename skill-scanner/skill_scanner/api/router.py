...
CloudDefenseAnalyzer: type | None
try:
    from ..core.analyzers.cloud_defense_analyzer import CloudDefenseAnalyzer

    CLOUD_DEFENSE_AVAILABLE = True
except (ImportError, ModuleNotFoundError):
    CLOUD_DEFENSE_AVAILABLE = False
    CloudDefenseAnalyzer = None
...
class ScanRequest(BaseModel):
    ...
    use_cloud_defense: bool = Field(False, description="Enable Cloud Defense analyzer")
    cloud_defense_api_url: str | None = Field(None, description="Cloud Defense API URL")
...
class BatchScanRequest(BaseModel):
    ...
    use_cloud_defense: bool = False
    cloud_defense_api_url: str | None = None
...
def _build_analyzers(
    ...
    *,
    ...
    vt_upload_files: bool = False,
    use_cloud_defense: bool = False,
    cloud_defense_api_key: str | None = None,
    cloud_defense_api_url: str | None = None,
    use_trigger: bool = False,
    ...
    return build_analyzers(
        ...
        use_cloud_defense=use_cloud_defense,
        cloud_defense_api_key=cloud_defense_api_key,
        cloud_defense_api_url=cloud_defense_api_url,
...
async def health_check():
    ...
    if CLOUD_DEFENSE_AVAILABLE:
        analyzers.append("cloud_defense_analyzer")
...
async def scan_skill(
    ...
    cloud_defense_api_key: str | None = Header(None, alias="X-CloudDefense-Key"),
):
    ...
    def run_scan():
        analyzers = _build_analyzers(
            ...
            use_cloud_defense=request.use_cloud_defense,
            cloud_defense_api_key=cloud_defense_api_key,
            cloud_defense_api_url=request.cloud_defense_api_url,
...
async def scan_uploaded_skill(
    ...
    use_cloud_defense: bool = Form(False, description="Enable Cloud Defense analyzer"),
    cloud_defense_api_key: str | None = Header(None, alias="X-CloudDefense-Key"),
    cloud_defense_api_url: str | None = Form(None, description="Cloud Defense API URL"),
    ...
    try:
        ...
        return await scan_skill(request, vt_api_key=vt_api_key, cloud_defense_api_key=cloud_defense_api_key)
...
async def scan_batch(
    ...
    background_tasks.add_task(run_batch_scan, scan_id, request, vt_api_key, cloud_defense_api_key)
