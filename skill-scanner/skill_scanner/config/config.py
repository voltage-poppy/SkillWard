...
class Config:
    ...
    enable_cloud_defense: bool = False

    # VirusTotal Configuration
    virustotal_api_key: str | None = None
    virustotal_upload_files: bool = False

    # Cloud Defense Configuration
    ...
    def __post_init__(self):
        ...
        if os.getenv("ENABLE_CLOUD_DEFENSE", "").lower() in ("true", "1"):
            self.enable_cloud_defense = True
        ...
        # Cloud Defense configuration from environment
        if self.cloud_defense_api_key is None:
            self.cloud_defense_api_key = os.getenv("CLOUD_DEFENSE_API_KEY")
