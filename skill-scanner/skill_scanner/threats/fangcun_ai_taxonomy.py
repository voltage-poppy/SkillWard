...
"""
FangcunGuard AI Security Framework - Ground Truth Taxonomy.

Source: https://learn-cloudsecurity.fangcunguard.com/ai-security-framework
Owner: Ankit Garg
Last Updated: 2026-02-02

This file contains the authoritative AITech and AISubtech codes from the
FangcunGuard Integrated AI Security and Safety Framework. All threat mappings in
threats.py must use codes that exist in this taxonomy.

To update this file when the framework changes:
1. Export data from https://learn-cloudsecurity.fangcunguard.com/ai-security-framework
...
def _flatten_framework_taxonomy(
    ...
    Supports the full FangcunGuard framework shape:
