...
const translations = {
  ...
  "report.rec.unsafe": { zh: "防护提示", en: "Protection Tips" },
  "report.remediation.title": { zh: "AI修复建议", en: "AI Fix Suggestions" },
  "report.remediation.cta_hint": { zh: "基于 Docker 运行时日志与 Guard 告警，让 LLM 给出针对性的 SKILL.md 修复建议。", en: "Analyze the Docker runtime log and Guard warnings to get targeted fix suggestions for SKILL.md from an LLM." },
  "report.remediation.generate": { zh: "生成 AI 修复", en: "Generate AI Fix Suggestions" },
  "report.remediation.loading": { zh: "正在分析 Docker 输出…", en: "Analyzing Docker output…" },
  "report.remediation.no_evidence": { zh: "此扫描未启用沙箱或日志已丢失，无法生成 AI 修复建议。", en: "This scan has no Docker sandbox logs to analyze." },
  "report.remediation.failed": { zh: "生成失败，请重试。", en: "Generation failed, please retry." },
  "report.remediation.empty": { zh: "未生成可操作的 AI 修复建议。", en: "No actionable AI fix suggestions were produced." },
  "report.remediation.retry": { zh: "重试", en: "Retry" },
  "report.remediation.code_before": { zh: "脆弱代码", en: "Vulnerable Code" },
  "report.remediation.code_after": { zh: "修复后代码", en: "Fixed Code" },
  "report.remediation.explanation": { zh: "说明", en: "Explanation" },
